...
Chat is a good place to state intent. It is a poor place to reconstruct an operation.

As soon as an AI system works for more than a few moments, the user needs another view: what is complete, what is waiting, what changed, which action needs approval, and what can safely happen next.

The interface is no longer only where the user speaks. It is where the work becomes legible.

That is why the workflow itself is becoming a user interface.
...
<WorkbenchShell
  title="Put execution around the work, not inside a transcript"
  description="A stable shell gives state, approvals, evidence, and history a predictable place."
  caption="The domain view can change while the operational controls remain familiar."
/>
...
## A system of record for agentic work

A workflow UI is also a sign that the product is moving beyond demos.
...
## From approachable to dependable

The chat box made AI approachable. The workflow makes ongoing work understandable.

For serious use, people need more than an answer: they need state, progress, checkpoints, recovery, cost, and control. A durable runtime supplies those facts; the interface turns them into judgment.

That is how AI moves from an impressive conversation to a dependable product.
